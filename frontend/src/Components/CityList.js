    ...
    render() {
        ...
        const columns = [
            ...
            },
            {
                ...
                key: 'country',
                render: country => {
                    let countryName = this.state.country_list[country.toLowerCase()]
                ...
                render: (text, item) => (
                    <span>
                        <Button basic color="blue" onClick={(e) => {
                            e.stopPropagation();
                            this.onOpenModalEdit(item)
                        }}>Editar</Button>
                        <Button basic color="red" onClick={(e) => {
                            e.stopPropagation();
                            this.onOpenModalRemove(e, item)
                        }}>Eliminar</Button>
                    </span>
                ),
            }
        ...
        const countryOptions = Object.keys(this.state.country_list).map(key =>
            <option value={key}>{this.capitalizeFirstLetter(key)}</option>
        )
